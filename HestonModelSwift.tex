...
I would also like to extend my deepest gratitude to Xanadu Trading Limited for providing me training in high-frequency derivatives training. In particular, to Alex Alvarez Ruiz and Florian Burkart for their role in my initial training and for sharing their knowledge through the several mathematical modelling projects I have worked on at Xanadu.

Thanks to Universitat Politecnica de Catalunya, and all the professors I studied under through my bachelor and master studies.

Special thanks to Centre de Formaci\`o Interdisciplinari\`a Superior (CFIS)
}
...
The performance, robustness, and convergence under real-market values is studied for different implementations of the SWIFT technique and compared with the option calibration scheme presented by \cite{cui17}
