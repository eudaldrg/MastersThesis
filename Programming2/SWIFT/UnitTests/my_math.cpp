...
{
    BOOST_CHECK_EQUAL(Swift::bitReverse(0b1101, 4), 0b1011);
    BOOST_CHECK_EQUAL(Swift::bitReverse(0b110101, 6), 0b101011);
    BOOST_CHECK_EQUAL(Swift::bitReverse(0b110101, 4), 0b1010);
}
